...
export const router = createBrowserRouter([
...

  {
    ...
    children: [
      ...
      // In-app pages given distinct paths so they don't collide with the public
      // marketing pages of the same name (/telemedicine, /insurance, /channels,
      // /partners) — the collision was routing logged-in users to the public page.
      { path: 'telehealth', element: <TelemedicinePage /> },
      { path: 'assistant', element: <AssistantPage /> },
      { path: 'cover', element: <InsurancePage /> },
      { path: 'claims', element: <ClaimsPage /> },
      { path: 'analytics', element: <AnalyticsPage /> },
      { path: 'messaging', element: <ChannelsPage /> },
      ...
      { path: 'ecosystem', element: <PartnersPage /> },
