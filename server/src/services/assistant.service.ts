...
const FAQ: Faq[] = [
  ...
  { id: 'insurance-partner', keywords: ['insurer', 'insurance', 'hmo', 'axa', 'mansard', 'partner', 'cover', 'company'], q: 'I have insurance through a partner — how do I use MobiCova?', a: 'If your insurer or HMO partners with MobiCova, you can enrol through them and use your plan via the app, USSD or WhatsApp. Check with your insurer, or contact us to confirm your plan is supported.' },
  ...
  { id: 'get-started', keywords: ['start', 'started', 'try', 'begin', 'first', 'new'], q: 'How do I get started?', a: 'The quickest way is to try the free Health Buddy — no sign-up needed. To enrol as a member, go through your organisation or insurance partner. If you represent a business, book a demo.' },
